...
print()
print(pd.DataFrame(energy_adapter1.get_energy_production()).head(5))  
print()
print(pd.DataFrame(energy_adapter2.get_energy_production()).head(5))        
print()   
print(pd.DataFrame(population_adapter.get_population()).head(5))
print()
print(pd.DataFrame(Logement_adapter.API_Logement_sociaux_bailleurs()).head(5))
